...
In this assignment you will implement neural networks, using the backpropagation algorithm described in the slides on neural networks. Regarding backpropagation, you should follow exactly the formulas and specifications on those slides.
Command-line Arguments

Your program takes five command-line arguments: <training_file>, <test_file>, <layers>, <units_per_layer>, <rounds>. The program should be invoked as follows:
